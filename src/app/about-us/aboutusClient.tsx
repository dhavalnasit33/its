...
const WhyChoosePremium = dynamic(
  () => import("@/components/home/WhyChoosePremium"),
  { ssr: false },
);
const GlobalPresenceAndIndustriesSection = dynamic(
  () =>
    import("@/components/new-home-components/GlobalPresenceAndIndustriesSection"),
  { ssr: false },
);
...
export default function AboutUsClient({
  ...
  const [aboutUsData, setAboutUsData] = useState<AboutUs | null>(
    initialData || null,
  );
          ...
          <div className="w-full z-10   text-center lg:max-w-5xl mx-auto">
            ...
            <motion.h2
              ...
              dangerouslySetInnerHTML={{
                __html:
                  aboutUsData?.heroSection?.subtitle.replace(
                    /<\/?h[1-6][^>]*>/gm,
                    "",
                  ) || "",
              }}
            ...
            >
              <div
                className="text-[#6f6f6f] text-base sm:text-lg md:text-[18px] font-medium leading-7 sm:leading-8 "
                // {aboutUsData.heroSection.description}
                dangerouslySetInnerHTML={{
                  __html: aboutUsData?.heroSection?.description || "",
                }}
              />
            </motion.div>
            ...
            >
              <ul className="inline-flex flex-wrap sm:flex-row  items-center justify-center bg-white shadow-md rounded-2xl md:rounded-full px-6 py-4  text-center  text-md md:text-lg">
                <li className="text-gray-700 font-medium flex ">
                  Global Clients{" "}
                  <span className="  text-[#d68029] px-3"> | </span>
                </li>
      ...
      <Section className=" bg-white z-10">
        <Row>
          ...
          <div className="w-full md:max-w-3xl">
            ...
            >
              <h2
                className=" w-full common-h2 text-black   rose max-w-none [&_a]:no-underline [&_a]:text-[#d68029] [&_a:hover]:underline [&_a]:cursor-pointer  "
                dangerouslySetInnerHTML={{
                  __html:
                    aboutUsData?.whyCompany?.title.replace(
                      /<\/?h[1-6][^>]*>/gm,
                      "",
                    ) || "",
                }}
          ...
          >
            {aboutUsData?.whyCompany?.companyDetails?.map((item, index) => (
              ...
              >
                ...
                <p
                  className="text-gray-600 fonts_16 "
                  dangerouslySetInnerHTML={{
          ...
          <div className="flex  flex-col w-full relative min-h-px max-w-full lg:max-w-[50%] ">
            ...
            >
              <h2
                ...
                dangerouslySetInnerHTML={{
                  __html:
                    aboutUsData?.goals?.goalsDetails?.title.replace(
                      /<\/?h[1-6][^>]*>/gm,
                      "",
                    ) || "",
                }}
            ...
            <motion.div
              ...
              dangerouslySetInnerHTML={{
                __html:
                  aboutUsData?.goals?.goalsDetails?.description.replace(
                    /<[^>]*>/g,
                    "",
                  ) || "",
              }}
          ...
          <div className=" w-full relative min-h-px max-w-full lg:max-w-[50%]">
            <div className="mb-6">
              ...
              >
                <div>
                  ...
                  <p
                    className="text-[#6f6f6f] text_16  "
                    dangerouslySetInnerHTML={{
                      __html: aboutUsData?.goals?.missionDescription || "",
                    }}
                  />
                </div>
            ...
            >
              ...
              <div className="bg-white rounded-[20px] p-6 shadow-[0_0_20px_rgba(0,0,0,0.15)] border border-gray-100 transition-all duration-300 hover:-translate-y-2.5 hover:shadow-[0_10px_30px_rgba(0,0,0,0.2)] ">
                ...
                <p
                  className="text_16 text-[#6f6f6f]   [&_p]:mb-4"
                  dangerouslySetInnerHTML={{
                    __html: aboutUsData?.goals?.visionDescription || "",
                  }}
                />
              </div>
              ...
              <div className="bg-white rounded-[20px] p-6 shadow-[0_0_20px_rgba(0,0,0,0.15)]  border border-gray-100 transition-all duration-300 hover:-translate-y-2.5 hover:shadow-[0_10px_30px_rgba(0,0,0,0.2)]">
                ...
                <div
                  className="text_16 text-[#6f6f6f]   "
                  dangerouslySetInnerHTML={{
                    __html: aboutUsData?.goals?.valuesDescription || "",
                  }}
                />
              </div>
            </motion.div>
        ...
        <Row>
          <div className="flex flex-col items-center w-full justify-center text-center mb-10">
            <motion.h2
              ...
              dangerouslySetInnerHTML={{
                __html:
                  aboutUsData?.flags?.title.replace(/<\/?h[1-6][^>]*>/gm, "") ||
                  "",
              }}
            />
            <Motion />
