...
const TIERS = [
  ...
  },
  {
    id: "edu-log",
    isSplit: true,
    left: { id: "", label: "Education", icon: LuGraduationCap },
  ...
  return (
    <section className="relative w-full min-h-screen bg-[#020713] overflow-hidden font-sans flex items-center justify-center py-20 lg:py-0">
      ...
      <div className="relative z-10 w-full max-w-[1500px] mx-auto px-4 flex flex-col xl:flex-row items-center justify-center gap-16 xl:gap-8">
        ...
        <div className="relative w-full xl:w-[540px] flex-shrink-0 z-20 mt-10 xl:mt-0">
          ...
          <div className="hidden xl:block absolute -left-[100px] top-1/2 -translate-y-1/2 w-[100px] h-[600px] pointer-events-none z-0">
            <svg width="100%" height="100%" className="overflow-visible">
              {/* Path matching the reference image exactly */}
              <motion.path
                initial={false}
                animate={{
          ...
          <div className="relative bg-[#050B14] border border-cyan-500/20 rounded-2xl p-8 shadow-[0_0_40px_rgba(6,182,212,0.1)]">
            {/* Top Left / Bottom Right Cyan Accent Corners */}
            <div className="absolute top-0 left-0 w-6 h-6 border-t-2 border-l-2 border-cyan-500 rounded-tl-2xl" />
            <div className="absolute bottom-0 right-0 w-6 h-6 border-b-2 border-r-2 border-cyan-500 rounded-br-2xl" />
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {/* Right Geometric Blue Block (Replaces broken image) */}
                <motion.div
                  key={activeTierId + "-image"}
                  initial={{ opacity: 0, scale: 0.95 }}
                  animate={{ opacity: 1, scale: 1 }}
                  exit={{ opacity: 0, scale: 0.95 }}
                  transition={{ duration: 0.35 }}
                  className="hidden md:flex w-[240px] h-[260px] items-center justify-center flex-shrink-0"
                >
                  <Image
                    ...
                    width={240}
                    height={260}
                    className="object-contain drop-shadow-[0_0_30px_rgba(0,180,255,0.25)]"
                  />
                </motion.div>
              </motion.div>
            </AnimatePresence>
