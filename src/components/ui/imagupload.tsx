                ...
                >
                    {value ? (
                        <>
                            ...
                            {!busy && (
                                <div className="absolute inset-0 bg-black/0 hover:bg-black/25 transition-all duration-200 flex items-center justify-center group">
                                    <button
                                        type="button"
                                        onClick={(e) => { e.stopPropagation(); inputRef.current?.click(); }}
                                        className="opacity-0 group-hover:opacity-100 bg-white/90 text-gray-700 text-xs font-medium px-3 py-1 rounded-full shadow transition-opacity duration-150"
                                    >
                                        Change
                                    </button>
                                </div>
                            ...
                            <button
                                ...
                                disabled={busy}
                                title="Remove image"
                                className="absolute top-2 right-2 bg-white/90 rounded-full p-1.5 shadow-md hover:bg-red-100 transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {isDeleting
