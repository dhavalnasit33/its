...
export default function ContactFooterPage() {
  ...
  const hireLink = nav.mainNav.find((l) => l.systemIdentifier === "hire");
  ...
  const isTrainingPage =
    pathname === "/training" ||
    (trainingLink ? pathname === `/${trainingLink.slug}` : false);
  ...
  return (
    <footer
      ...
      className={` relative bg-white scroll-mt-14 ${
        !isContactPage ? " pt-16 lg:pt-18 xl:pt-22" : ""
      }`}
    >
      {/* ---------------- Contact Form Floating Card ---------------- */}
      {/* <div className="w-full relative mx-auto max-w-[90%] lg:max-w-[80%] pb-16 "> */}
      <Row className={`${!isContactPage ? "pb-16 lg:pb-18 xl:pb-22" : ""}`}>
        {/* <div className="  w-full mx-auto md:-mb-90 relative z-10">
          <div className="bg-white md:shadow-[0_0_12.2px_0_rgba(0,0,0,0.25)] rounded-2xl p-2 md:p-10">
            {isTrainingPage ? (
              <TrainingContactForm />
      ...
      <Section className="bg-gray-100 py-14!">
        <Row className=" mx-auto  rounded-xl ">
          ...
          <div className="flex max-lg:flex-wrap items-center gap-6 justify-between">
            ...
            <div className=" flex gap-8 lg:gap-10 lg:justify-end max-lg:flex-wrap">
              <div className="flex items-center gap-4">
                <Link href={`tel:${phonePrimaryClean}`}>
                  <div className="  w-12 h-12 rounded-full flex items-center justify-center bg-linear-to-r from-[#d68029] to-[#f7b733] ">
              ...
              <div className="flex items-center gap-4">
                <Link
                  href={
                    microsoftHandle.startsWith("http")
                      ? microsoftHandle
                      : `https://teams.microsoft.com/l/chat/0/0?users=${microsoftHandle}`
                  }
                >
                  <div className="  w-12 h-12 rounded-full flex items-center justify-center bg-linear-to-r from-[#d68029] to-[#f7b733] ">
                    <FaMicrosoft size={22} className="text-white" />
                  </div>
                </Link>
          ...
          >
            <p className=" break-all text-gray-700 lg:text-left ">
              Empowering businesses with innovative web and mobile solutions
              that drive
              <br />
              digital transformation, growth, and long-term success.
            </p>
      ...
      <Section className="py-8!">
        <Row className="flex flex-col space-y-5 md:space-y-7 ">
          ...
          <div>
            <h4 className="font-bold text-lg mb-3">AI Services</h4>
            <ul className="flex flex-wrap">
          ...
          <div>
            ...
            <ul className="flex flex-wrap ">
              {serviceData.map((service, index) => (
                <li key={service.slug || index} className="list-none py-1">
                  <Link
                    href={`/${service.slug}`}
