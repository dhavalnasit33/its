...
function StepIcon({ index }: { index: number }) {
  switch (index) {
    case 0:
      return (
        <svg className="w-6 h-6 text-[#D68029]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
    ...
    <Section className=" overflow-hidden">
      <Row>
        ...
        <div className="relative w-full">
          ...
          <div className="absolute left-7 md:left-1/2 md:-translate-x-1/2 top-28 sm:top-20 max-[480px]:bottom-30 bottom-28 sm:bottom-20 w-0.5 bg-gray-100" />
              ...
              return (
                ...
                >
                  ...
                  <div className="w-full md:w-1/2 pl-18 md:pl-0 md:pr-16 order-2 md:order-1 flex justify-start md:justify-end">
                    {isEven && (
                      ...
                      >
                        ...
                        <span className="inline-flex items-center rounded-full border border-[#D68029]/50 bg-[#D68029]/5 px-4 py-1 text-[11px] font-semibold uppercase tracking-widest   text-[#D68029] mb-2">
                        {step.number} &mdash; Step
                        </span>
                  ...
                  <div className="absolute left-0 md:left-1/2 md:-translate-x-1/2 top-1/2 -translate-y-1/2 z-10 order-1 md:order-2 flex items-center justify-center">
                    <div className="w-14 h-14 rounded-full bg-white border-2 border-gray-200 hover:border-[#D68029] flex items-center justify-center shadow-md transition-colors duration-300">
                      <StepIcon index={idx} />
                    </div>
                  </div>
