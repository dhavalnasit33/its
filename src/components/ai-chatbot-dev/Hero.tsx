        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-16 relative z-10 w-full">
          ...
          <div className="w-full max-w-full lg:max-w-[48%]">
            ...
            >
              ...
              <span className="text-[#D27E2B]">That Drive Conversations</span> and Business Growth
            </motion.h1>
            ...
            >
              We build AI chatbots powered by GPT, Claude, Gemini, and custom LLMs that automate customer support, sales, lead generation, and business operations.
            </motion.p>
          ...
          {/* ── Right Column: 3D Chatbot Visual Simulation ── */}
          <motion.div
          ...
          >
            ...
            <div className="relative w-full z-10">
              <Image
                src="/ai-strategy/ai-chartbot-development/chatbot-hero.png"
                alt="AI Chatbot Development"
                width={850}
                height={850}
                priority
                className="object-contain w-full h-auto drop-shadow-xl scale-110 lg:scale-120 transition-transform duration-500"
              />
            </div>
          </motion.div>
        </div>
